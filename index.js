...
async function addStudent() {
  ...
  if (name && mobile && address) {
    try {
      const response = await axios.post("https://crudcrud.com/api/0f7fdcac57f84a9fa34e8c07e1c476bd/msg", {
        name: name,
        mobile: mobile,
        address: address
      });
...
async function deleteStudent(id) {
  try {
    await axios.delete(`https://crudcrud.com/api/0f7fdcac57f84a9fa34e8c07e1c476bd/msg/${id}`);
...
async function fetchStudents() {
  try {
    const response = await axios.get("https://crudcrud.com/api/0f7fdcac57f84a9fa34e8c07e1c476bd/msg");
...
async function addOrUpdateStudent() {
  ...
  if (name && mobile && address) {
    if (currentEditId) {
      try {
        await axios.put(`https://crudcrud.com/api/0f7fdcac57f84a9fa34e8c07e1c476bd/msg/${currentEditId}`, {
          name: name,
          mobile: mobile,
          address: address
        });
